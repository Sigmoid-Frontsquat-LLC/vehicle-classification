...
public sealed class Classification : Singleton<Classification> {
	...
	public static string Endpoint { get; set; } = "192.168.2.11";
	...
	private IEnumerator DoClassify(byte[] image, object owner) {
		...
		var request = WebRequest.CreateApiPostRequest(Classification.Endpoint, Classification.Port, "/classify", classificationRequest);
